...
Vercel automatycznie deployuje przy każdym pushu - **zero dodatkowej konfiguracji!**

- **Push do `main`** → automatyczny deployment na produkcję
- **Pull Request** → deployment preview z unikalnym URL
- **Każdy branch** → możesz zobaczyć podgląd

✅ **To działa od razu po podłączeniu repo do Vercel!**

### Automatyczne testy (GitHub Actions)

Dodatkowo GitHub Actions uruchamia testy przy każdym pushu:

- ✅ Linting + type checking
- ✅ Unit tests + coverage
- ✅ Build verification

Zobacz: `.github/workflows/test.yml`
